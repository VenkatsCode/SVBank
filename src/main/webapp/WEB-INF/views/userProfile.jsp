...
body {
	...
	<div class="container">
		<form:form class="form-horizontal" action="edituserdetails" method="POST"
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<form:input type="text" path="firstName" class="form-control"
							id="firstName" placeholder="required" readonly="true" style="color: maroon;"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-9">
						<form:input type="text" class="form-control" path="lastName"
							id="lastName" placeholder="required" readonly="true" style="color: maroon;"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-9">
						<form:select data-toggle="select" path="gender"
							class="form-control select select-default" disabled="true" style="color: maroon;">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<form:input type="date" class="form-control" path="dob" id="dob"
							placeholder="required" readonly="true" style="color: maroon;"/>
					</div>
				</div>
				<div class="form-group">
